        ...
        return (
          <div key={question} className={index ? "border-t border-black/10" : ""}>
            <button
              ...
              className="group flex w-full items-center justify-between gap-6 py-5 text-left font-bold outline-none transition-colors hover:text-[#1e658c] focus-visible:text-[#1e658c]"
            >
              <span>{question}</span>
