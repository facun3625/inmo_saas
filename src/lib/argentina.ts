...
export const BUSINESS_CATEGORIES = ["Inmobiliaria", "Corredor/a inmobiliario/a", "Administración de alquileres", "Administración de consorcios", "Desarrolladora inmobiliaria", "Otro"] as const;
